...
| `PLUGWERK_AUTH_ADMIN_PASSWORD` | **yes** | — | Initial admin password. When set, skips random generation and the forced password change. |
...
| `PLUGWERK_AUTH_ADMIN_USERNAME` | no | `admin` | Username of the superadmin account created on first startup |
