...
INSERT INTO namespace (id, slug, owner_org) VALUES
  ('00000000-0000-0000-0000-000000000001', 'default',    'devtank42'),
...
INSERT INTO plugin (id, namespace_id, plugin_id, name, description, author, license, categories, tags, status) VALUES
  ('10000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000001','io.plugwerk.auth-sso','Auth SSO','Single sign-on integration for enterprise systems','devtank42','MIT','{Security,Auth}','{sso,oauth2,enterprise}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000001','io.plugwerk.audit-log','Audit Log','Persistent audit trail for all user actions','devtank42','MIT','{Compliance,Security}','{audit,logging,compliance}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000001','io.plugwerk.backup-manager','Backup Manager','Automated backup scheduling and restore','devtank42','Apache-2.0','{Operations}','{backup,restore,scheduling}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000004','00000000-0000-0000-0000-000000000001','io.plugwerk.cache-redis','Cache Redis','Redis-backed caching layer with TTL support','devtank42','MIT','{Performance}','{cache,redis,performance}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000005','00000000-0000-0000-0000-000000000001','io.plugwerk.csv-export','CSV Export','Bulk data export in CSV and Excel formats','devtank42','MIT','{Data,Export}','{csv,excel,export}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000006','00000000-0000-0000-0000-000000000001','io.plugwerk.dashboard-widgets','Dashboard Widgets','Customizable dashboard widget framework','devtank42','MIT','{UI}','{dashboard,widgets,ui}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000007','00000000-0000-0000-0000-000000000001','io.plugwerk.email-templates','Email Templates','HTML email template engine with preview','devtank42','MIT','{Notifications}','{email,templates,notifications}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000008','00000000-0000-0000-0000-000000000001','io.plugwerk.feature-flags','Feature Flags','Runtime feature flag management','devtank42','Apache-2.0','{Operations}','{feature-flags,runtime,config}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000009','00000000-0000-0000-0000-000000000001','io.plugwerk.geo-ip','Geo IP','IP geolocation lookup with MaxMind GeoIP2','devtank42','MIT','{Analytics}','{geo,ip,location}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000010','00000000-0000-0000-0000-000000000001','io.plugwerk.health-checks','Health Checks','Extended health check endpoints for monitoring','devtank42','MIT','{Operations,Monitoring}','{health,monitoring,actuator}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000011','00000000-0000-0000-0000-000000000001','io.plugwerk.i18n-manager','I18n Manager','Translation management with hot-reload','devtank42','MIT','{UI,Localization}','{i18n,l10n,translations}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000012','00000000-0000-0000-0000-000000000001','io.plugwerk.job-scheduler','Job Scheduler','Quartz-based distributed job scheduler','devtank42','Apache-2.0','{Operations}','{scheduler,quartz,cron}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000013','00000000-0000-0000-0000-000000000001','io.plugwerk.kafka-bridge','Kafka Bridge','Kafka event streaming integration','devtank42','Apache-2.0','{Messaging}','{kafka,streaming,events}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000014','00000000-0000-0000-0000-000000000001','io.plugwerk.ldap-sync','LDAP Sync','Active Directory / LDAP user synchronisation','devtank42','MIT','{Auth,Security}','{ldap,active-directory,sync}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000015','00000000-0000-0000-0000-000000000001','io.plugwerk.metrics-collector','Metrics Collector','Prometheus metrics collection and aggregation','devtank42','MIT','{Monitoring}','{prometheus,metrics,monitoring}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000016','00000000-0000-0000-0000-000000000001','io.plugwerk.notification-hub','Notification Hub','Multi-channel notification dispatcher','devtank42','MIT','{Notifications}','{notifications,push,webhook}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000017','00000000-0000-0000-0000-000000000001','io.plugwerk.oauth2-provider','OAuth2 Provider','Built-in OAuth2 authorization server','devtank42','MIT','{Auth}','{oauth2,jwt,auth}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000018','00000000-0000-0000-0000-000000000001','io.plugwerk.pdf-generator','PDF Generator','Wkhtmltopdf-based PDF generation service','devtank42','MIT','{Export,Documents}','{pdf,documents,export}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000019','00000000-0000-0000-0000-000000000001','io.plugwerk.rate-limiter','Rate Limiter','Token-bucket rate limiting per user/IP','devtank42','MIT','{Security,Performance}','{rate-limiting,throttling,security}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000020','00000000-0000-0000-0000-000000000001','io.plugwerk.search-elasticsearch','Search Elasticsearch','Full-text search powered by Elasticsearch','devtank42','Apache-2.0','{Search,Data}','{elasticsearch,search,fulltext}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000021','00000000-0000-0000-0000-000000000001','io.plugwerk.session-manager','Session Manager','Distributed session storage with Redis','devtank42','MIT','{Auth,Performance}','{session,redis,auth}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000022','00000000-0000-0000-0000-000000000001','io.plugwerk.tenant-isolation','Tenant Isolation','Multi-tenancy schema isolation layer','devtank42','MIT','{Security,Multi-tenancy}','{multi-tenancy,isolation,saas}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000023','00000000-0000-0000-0000-000000000001','io.plugwerk.ui-theme-engine','UI Theme Engine','Dynamic theming with CSS variable injection','devtank42','MIT','{UI}','{theming,css,ui}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000024','00000000-0000-0000-0000-000000000001','io.plugwerk.version-check','Version Check','Automated dependency vulnerability scanning','devtank42','MIT','{Security,Operations}','{vulnerability,security,deps}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000025','00000000-0000-0000-0000-000000000001','io.plugwerk.webhook-router','Webhook Router','Configurable webhook fanout with retry','devtank42','MIT','{Integrations}','{webhook,integrations,http}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000026','00000000-0000-0000-0000-000000000001','io.plugwerk.xml-transformer','XML Transformer','XSLT-based XML transformation pipeline','devtank42','MIT','{Data,Transform}','{xml,xslt,transform}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000027','00000000-0000-0000-0000-000000000001','io.plugwerk.yaml-config','YAML Config','Hot-reloadable YAML configuration store','devtank42','MIT','{Operations}','{config,yaml,hot-reload}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000028','00000000-0000-0000-0000-000000000001','io.plugwerk.zip-archiver','ZIP Archiver','On-the-fly ZIP archive creation and streaming','devtank42','MIT','{Data,Export}','{zip,archive,streaming}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000029','00000000-0000-0000-0000-000000000001','io.plugwerk.db-migrator','DB Migrator','Schema migration automation for plugin databases','devtank42','MIT','{Database}','{migration,schema,database}','ACTIVE'),
  ('10000000-0000-0000-0000-000000000030','00000000-0000-0000-0000-000000000001','io.plugwerk.analytics-tracker','Analytics Tracker','Event tracking and funnel analytics','devtank42','MIT','{Analytics}','{analytics,events,tracking}','ARCHIVED')
...
JOIN (VALUES
  -- default namespace
  ('io.plugwerk.auth-sso',           '00000000-0000-0000-0000-000000000001','1.3.2','a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2','artifacts/default/auth-sso/1.3.2.jar',           '>=2.0.0','5 days'),
  ('io.plugwerk.audit-log',           '00000000-0000-0000-0000-000000000001','2.1.0','b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3','artifacts/default/audit-log/2.1.0.jar',           '>=2.0.0','10 days'),
  ('io.plugwerk.backup-manager',      '00000000-0000-0000-0000-000000000001','1.0.5','c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4','artifacts/default/backup-manager/1.0.5.jar',      NULL,      '15 days'),
  ('io.plugwerk.cache-redis',         '00000000-0000-0000-0000-000000000001','3.0.1','d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5','artifacts/default/cache-redis/3.0.1.jar',         '>=3.0.0','3 days'),
  ('io.plugwerk.csv-export',          '00000000-0000-0000-0000-000000000001','1.4.0','e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6','artifacts/default/csv-export/1.4.0.jar',          NULL,      '20 days'),
  ('io.plugwerk.dashboard-widgets',   '00000000-0000-0000-0000-000000000001','2.3.1','f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7','artifacts/default/dashboard-widgets/2.3.1.jar',   NULL,      '8 days'),
  ('io.plugwerk.email-templates',     '00000000-0000-0000-0000-000000000001','1.1.3','a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8','artifacts/default/email-templates/1.1.3.jar',     NULL,      '25 days'),
  ('io.plugwerk.feature-flags',       '00000000-0000-0000-0000-000000000001','4.0.0','b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9','artifacts/default/feature-flags/4.0.0.jar',       '>=2.0.0','2 days'),
  ('io.plugwerk.geo-ip',              '00000000-0000-0000-0000-000000000001','1.0.2','c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0','artifacts/default/geo-ip/1.0.2.jar',              NULL,      '45 days'),
  ('io.plugwerk.health-checks',       '00000000-0000-0000-0000-000000000001','2.0.0','d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1','artifacts/default/health-checks/2.0.0.jar',       NULL,      '30 days'),
  ('io.plugwerk.i18n-manager',        '00000000-0000-0000-0000-000000000001','1.5.1','e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2','artifacts/default/i18n-manager/1.5.1.jar',        NULL,      '12 days'),
  ('io.plugwerk.job-scheduler',       '00000000-0000-0000-0000-000000000001','3.2.0','f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3','artifacts/default/job-scheduler/3.2.0.jar',       '>=2.5.0','7 days'),
  ('io.plugwerk.kafka-bridge',        '00000000-0000-0000-0000-000000000001','1.0.0','a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4','artifacts/default/kafka-bridge/1.0.0.jar',        '>=3.0.0','1 day'),
  ('io.plugwerk.ldap-sync',           '00000000-0000-0000-0000-000000000001','2.2.4','b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5','artifacts/default/ldap-sync/2.2.4.jar',           NULL,      '18 days'),
  ('io.plugwerk.metrics-collector',   '00000000-0000-0000-0000-000000000001','1.3.0','c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6','artifacts/default/metrics-collector/1.3.0.jar',   NULL,      '14 days'),
  ('io.plugwerk.notification-hub',    '00000000-0000-0000-0000-000000000001','2.0.3','d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7','artifacts/default/notification-hub/2.0.3.jar',    '>=2.0.0','6 days'),
  ('io.plugwerk.oauth2-provider',     '00000000-0000-0000-0000-000000000001','1.8.2','e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8','artifacts/default/oauth2-provider/1.8.2.jar',     '>=2.0.0','9 days'),
  ('io.plugwerk.pdf-generator',       '00000000-0000-0000-0000-000000000001','1.0.7','f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9','artifacts/default/pdf-generator/1.0.7.jar',       NULL,      '35 days'),
  ('io.plugwerk.rate-limiter',        '00000000-0000-0000-0000-000000000001','2.5.0','a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0','artifacts/default/rate-limiter/2.5.0.jar',        NULL,      '4 days'),
  ('io.plugwerk.search-elasticsearch','00000000-0000-0000-0000-000000000001','0.9.1','b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1','artifacts/default/search-elasticsearch/0.9.1.jar','>=3.0.0','50 days'),
  ('io.plugwerk.session-manager',     '00000000-0000-0000-0000-000000000001','1.1.0','c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2','artifacts/default/session-manager/1.1.0.jar',     NULL,      '22 days'),
  ('io.plugwerk.tenant-isolation',    '00000000-0000-0000-0000-000000000001','1.0.1','d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3','artifacts/default/tenant-isolation/1.0.1.jar',    '>=2.0.0','40 days'),
  ('io.plugwerk.ui-theme-engine',     '00000000-0000-0000-0000-000000000001','3.1.0','e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4','artifacts/default/ui-theme-engine/3.1.0.jar',     NULL,      '11 days'),
  ('io.plugwerk.version-check',       '00000000-0000-0000-0000-000000000001','1.2.3','f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5','artifacts/default/version-check/1.2.3.jar',       NULL,      '17 days'),
  ('io.plugwerk.webhook-router',      '00000000-0000-0000-0000-000000000001','2.4.1','a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6','artifacts/default/webhook-router/2.4.1.jar',      NULL,      '13 days'),
  ('io.plugwerk.xml-transformer',     '00000000-0000-0000-0000-000000000001','1.0.0','b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7','artifacts/default/xml-transformer/1.0.0.jar',     NULL,      '90 days'),
  ('io.plugwerk.yaml-config',         '00000000-0000-0000-0000-000000000001','2.0.0','c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8','artifacts/default/yaml-config/2.0.0.jar',         NULL,      '28 days'),
  ('io.plugwerk.zip-archiver',        '00000000-0000-0000-0000-000000000001','1.3.5','d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9','artifacts/default/zip-archiver/1.3.5.jar',        NULL,      '16 days'),
  ('io.plugwerk.db-migrator',         '00000000-0000-0000-0000-000000000001','1.0.0','e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0','artifacts/default/db-migrator/1.0.0.jar',         NULL,      '55 days'),
  ('io.plugwerk.analytics-tracker',   '00000000-0000-0000-0000-000000000001','0.8.0','f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1','artifacts/default/analytics-tracker/0.8.0.jar',   NULL,      '120 days'),
  -- acme-corp namespace
