...
val pf4jPluginId          = "io.plugwerk.example.webapp.env"
val pf4jPluginClass       = "io.plugwerk.example.webapp.env.EnvPlugin"
val pf4jPluginVersion     = project.version.toString()
val pf4jPluginProvider    = "plugwerk-examples"
val pf4jPluginDescription = "Example webapp plugin — adds an environment variables page"
...
tasks.jar {
    manifest {
        attributes(
            ...
            "Plugin-Name"        to "Environment Page Plugin",
            "Plugin-License"     to "Apache-2.0",
            "Plugin-Tags"        to "env, demo, webapp, environment, monitoring",
        )
    }
}
...
//
//   io.plugwerk.example.webapp.env-<version>.zip
//   ├── META-INF/MANIFEST.MF   ← loose file (required by ManifestPluginDescriptorFinder)
//   └── lib/
//       └── plugwerk-example-plugin-env-<version>.jar
//
