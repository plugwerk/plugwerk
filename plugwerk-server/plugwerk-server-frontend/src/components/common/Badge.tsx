...
const styles: Record<BadgeVariant, { bg: string; color: string }> = {
  ...
  published: {
    bg: tokens.badge.published.bg,
    color: tokens.badge.published.text,
  },
  draft: { bg: tokens.badge.draft.bg, color: tokens.badge.draft.text },
  deprecated: {
    bg: tokens.badge.deprecated.bg,
    color: tokens.badge.deprecated.text,
  },
  ...
  suspended: {
    bg: tokens.badge.suspended.bg,
    color: tokens.badge.suspended.text,
  },
  archived: { bg: tokens.badge.archived.bg, color: tokens.badge.archived.text },
  "pending-review": {
    bg: tokens.badge.pendingReview.bg,
    color: tokens.badge.pendingReview.text,
  },
};
