      ...
      >
        ...
        <Box sx={{ display: "flex", gap: 1.5, width: "100%" }}>
          ...
          <Box sx={{ flex: 1, minWidth: 0 }}>
            ...
            >
              <Tooltip
                title={nameOverflowing ? plugin.name : ""}
                placement="top"
              >
                <Typography
                  ref={nameRef}
              ...
              {statusBadge && (
                <Badge variant={statusBadge}>
                  {plugin.status!.charAt(0).toUpperCase() +
                    plugin.status!.slice(1)}
                </Badge>
              )}
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
              <Tooltip
                title={providerOverflowing ? `by ${plugin.provider}` : ""}
                placement="bottom"
              >
                <Typography
                  ref={providerRef}
        ...
        {plugin.description && (
          <Tooltip
            title={descOverflowing ? plugin.description : ""}
            placement="bottom"
          >
            <Typography
              ref={descRef}
