...
export interface PluginUpdateInfo {
    ...
    'pluginId': string;
    /**
     * The version currently installed on the client
     * @type {string}
     * @memberof PluginUpdateInfo
     */
    'currentVersion': string;
    /**
     * The latest published version available on the server
     * @type {string}
     * @memberof PluginUpdateInfo
     */
    'latestVersion': string;
    /**
     * Full release details for the latest available version
