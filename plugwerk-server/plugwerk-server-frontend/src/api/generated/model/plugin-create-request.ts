...
/**
 * Request body for creating a new plugin entry in a namespace
 * @export
 * @interface PluginCreateRequest
 */
export interface PluginCreateRequest {
    /**
     * PF4J plugin identifier. Must match `Plugin-Id` in the plugin manifest exactly. Unique within the namespace. 
     * @type {string}
    ...
    'description'?: string;
    /**
     * Author or maintainer name or organisation
     * @type {string}
     * @memberof PluginCreateRequest
     */
    'author'?: string;
    /**
     * SPDX license expression (e.g. `Apache-2.0`, `MIT`)
     * @type {string}
     * @memberof PluginCreateRequest
     */
    'license'?: string;
    /**
     * Category slugs for catalog browsing and filtering
     * @type {Array<string>}
     * @memberof PluginCreateRequest
     */
    ...
    'tags'?: Array<string>;
    /**
     * URL to plugin icon (recommended 128×128 px)
     * @type {string}
     * @memberof PluginCreateRequest
     */
    'icon'?: string;
