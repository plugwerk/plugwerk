...
/**
 * Successful login response containing the access token
 * @export
 * @interface LoginResponse
 */
export interface LoginResponse {
    /**
     * Signed JWT Bearer token. Include in subsequent requests as: `Authorization: Bearer <accessToken>` 
     * @type {string}
    ...
    'tokenType': string;
    /**
     * Token validity duration in seconds (default: 28800 = 8 hours)
     * @type {number}
     * @memberof LoginResponse
     */
    'expiresIn': number;
    /**
     * When `true`, the user must change their password before accessing any resource. The frontend should redirect to the change-password page immediately after login. 
     * @type {boolean}
     * @memberof LoginResponse
     */
