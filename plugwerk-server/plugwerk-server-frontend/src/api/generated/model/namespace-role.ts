...
/**
 * Namespace-scoped role: - `ADMIN`: full write access including member and access key management - `MEMBER`: upload releases, manage plugin metadata, view review queue - `READ_ONLY`: browse catalog and download artifacts only 
 * @export
 * @enum {string}
 */

export const NamespaceRole = {
    Admin: 'ADMIN',
    Member: 'MEMBER',
    ReadOnly: 'READ_ONLY'
} as const;

export type NamespaceRole = typeof NamespaceRole[keyof typeof NamespaceRole];
