...
/**
 * A release that is pending admin review
 * @export
 * @interface ReviewItemDto
 */
export interface ReviewItemDto {
    /**
     * Internal UUID of the release (use this in approve/reject endpoints)
     * @type {string}
    ...
    'pluginName': string;
    /**
     * SemVer version of the release awaiting review
     * @type {string}
     * @memberof ReviewItemDto
     */
    'version': string;
    /**
     * Username of the account that uploaded the release
     * @type {string}
     * @memberof ReviewItemDto
     */
    'submittedBy'?: string;
    ...
    'submittedAt': string;
    /**
     * SHA-256 hex digest of the artifact (for manual verification before approving)
     * @type {string}
     * @memberof ReviewItemDto
     */
