...
/**
 * Release entry in pf4j-update format
 * @export
...
export interface Pf4jReleaseInfo {
    ...
    'version': string;
    /**
     * Release date (ISO-8601, e.g. `2026-01-15`)
     * @type {string}
     * @memberof Pf4jReleaseInfo
     */
    'date'?: string;
    ...
    'url': string;
    /**
     * Minimum host application version required, in pf4j-update range format. Corresponds to `requiresSystemVersion` in the Plugwerk release model. 
     * @type {string}
     * @memberof Pf4jReleaseInfo
     */
    'requires'?: string;
    /**
     * SHA-512 hex digest of the artifact for integrity verification
     * @type {string}
     * @memberof Pf4jReleaseInfo
     */
    'sha512sum'?: string;
