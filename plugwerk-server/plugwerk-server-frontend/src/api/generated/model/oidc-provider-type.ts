...
/**
 * Provider type. Pre-configured providers (GITHUB, GOOGLE, FACEBOOK) have well-known endpoints embedded — only clientId and clientSecret are required. GENERIC_OIDC and KEYCLOAK require an explicit issuerUri. 
 * @export
 * @enum {string}
 */
...
export type OidcProviderType = typeof OidcProviderType[keyof typeof OidcProviderType];
