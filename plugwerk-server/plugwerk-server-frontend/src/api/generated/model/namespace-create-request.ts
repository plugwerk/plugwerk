...
export interface NamespaceCreateRequest {
    /**
     * Globally unique, URL-safe namespace identifier. Lowercase alphanumeric with hyphens, 2–64 characters, cannot start or end with a hyphen. 
     * @type {string}
     * @memberof NamespaceCreateRequest
     */
    'slug': string;
    /**
     * Human-readable name of the owning organisation (optional, for display only)
     * @type {string}
     * @memberof NamespaceCreateRequest
     */
    'ownerOrg'?: string;
