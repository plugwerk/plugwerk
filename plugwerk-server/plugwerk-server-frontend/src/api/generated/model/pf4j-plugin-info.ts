...
// @ts-ignore
import type { Pf4jReleaseInfo } from './pf4j-release-info';

/**
 * Plugin entry in pf4j-update format
 * @export
 * @interface Pf4jPluginInfo
 */
export interface Pf4jPluginInfo {
    /**
     * PF4J plugin identifier
     * @type {string}
     * @memberof Pf4jPluginInfo
     */
    'id': string;
    /**
    ...
    'description'?: string;
    /**
     * Plugin author or provider name
     * @type {string}
     * @memberof Pf4jPluginInfo
     */
    'provider'?: string;
    ...
    'projectUrl'?: string;
    /**
     * List of published releases for this plugin, newest first
     * @type {Array<Pf4jReleaseInfo>}
     * @memberof Pf4jPluginInfo
     */
    'releases': Array<Pf4jReleaseInfo>;
}
