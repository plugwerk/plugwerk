...
// @ts-ignore
import type { NamespaceRole } from './namespace-role';

/**
 * 
 * @export
 * @interface NamespaceMemberDto
 */
export interface NamespaceMemberDto {
    /**
     * Local username or OIDC sub claim
     * @type {string}
     * @memberof NamespaceMemberDto
     */
    'userSubject': string;
    /**
     * 
