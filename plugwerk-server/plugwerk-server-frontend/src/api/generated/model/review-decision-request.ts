...
/**
 * Optional comment to attach to an approve or reject decision
 * @export
 * @interface ReviewDecisionRequest
 */
export interface ReviewDecisionRequest {
    /**
     * Human-readable comment explaining the decision. Strongly recommended for rejections so the publisher knows what needs to be fixed. 
     * @type {string}
