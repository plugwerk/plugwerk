...
/**
 * Plugin feed in the [pf4j-update](https://github.com/pf4j/pf4j-update) `plugins.json` format. This is the root object returned by the `GET /plugins.json` endpoint. 
 * @export
 * @interface Pf4jPluginsJson
 */
export interface Pf4jPluginsJson {
    /**
     * List of all plugins with their published releases
