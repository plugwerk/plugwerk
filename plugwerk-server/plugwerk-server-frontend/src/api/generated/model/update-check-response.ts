...
/**
 * Update check result — contains only plugins that have a newer version available
 * @export
 * @interface UpdateCheckResponse
 */
export interface UpdateCheckResponse {
    /**
     * List of plugins with available updates. Plugins that are already at the latest published version are omitted. An empty array means everything is up to date. 
