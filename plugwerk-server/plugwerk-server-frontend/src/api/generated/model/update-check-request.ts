...
/**
 * List of currently installed plugins to check for updates
 * @export
 * @interface UpdateCheckRequest
 */
export interface UpdateCheckRequest {
    /**
     * The installed plugins to check. Up to 500 entries per request. Plugins not found in the namespace are silently ignored. 
