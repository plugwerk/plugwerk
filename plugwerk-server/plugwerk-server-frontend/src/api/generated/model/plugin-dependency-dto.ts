...
/**
 * A dependency on another plugin, with a version constraint
 * @export
 * @interface PluginDependencyDto
 */
export interface PluginDependencyDto {
    /**
     * PF4J plugin identifier of the required plugin
     * @type {string}
     * @memberof PluginDependencyDto
     */
    'id': string;
    /**
     * SemVer range constraint for the required plugin version. Examples: `>=1.0.0`, `>=1.0.0 & <2.0.0` 
     * @type {string}
     * @memberof PluginDependencyDto
     */
    'version': string;
