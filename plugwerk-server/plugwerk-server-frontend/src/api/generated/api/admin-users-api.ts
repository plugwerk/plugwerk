...
/**
 * Request parameters for deleteUser operation in AdminUsersApi.
 * @export
 * @interface AdminUsersApiDeleteUserRequest
 */
export interface AdminUsersApiDeleteUserRequest {
    /**
     * 
     * @type {string}
     * @memberof AdminUsersApiDeleteUser
     */
...
export class AdminUsersApi extends BaseAPI {
     ...
     * @memberof AdminUsersApi
     */
    public deleteUser(requestParameters: AdminUsersApiDeleteUserRequest, options?: RawAxiosRequestConfig) {
        return AdminUsersApiFp(this.configuration).deleteUser(requestParameters.userId, options).then((request) => request(this.axios, this.basePath));
    }
