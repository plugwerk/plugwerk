...
const mockAxiosInstance = axiosInstance as unknown as {
...
describe("usePluginStore", () => {
  ...
  describe("fetchPlugins", () => {
    ...
    it("sets loading to true while fetching", async () => {
      ...
      act(() => {
        void usePluginStore.getState().fetchPlugins("acme");
      });
