 ...
 *   Verified via `PasswordEncoder.matches()` during authentication.
 * @property keyPrefix First 8 characters of the plaintext key for candidate lookup
 *   (e.g. `pwk_abcd`). BCrypt hashes are salted and cannot be looked up directly.
